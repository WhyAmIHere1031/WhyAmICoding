...
export var wallSound = new soundFile("phaserDown2.mp3"); //load sound
...
export var ambientSound = new soundFile("Kiss The Heavens - Asher Fulero.mp3");
